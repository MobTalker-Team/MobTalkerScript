...
public class AnnotatedConsoleCommandLib
{
    private final MtsGlobals _G;
    
    public AnnotatedConsoleCommandLib( MtsGlobals g )
    {
        _G = g;
    }
    ...
    public void ShowText( MtsValue arg1, MtsValue arg2, MtsValue arg3 )
    {
        ...
        if ( !arg1.isNil() )
        {
            String name = arg1.is( MtsDummyCharacter.TYPE )
                    ? arg1.<MtsDummyCharacter> asNative().getName().asJavaString()
