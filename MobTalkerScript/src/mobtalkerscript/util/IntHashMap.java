 ...
 * 
 * <p>
 * Note that this class is for internal optimization purposes only, and may not be supported in future releases of Apache
 * Commons Lang. Utilities of this sort may be included in future releases of Apache Commons Collections.
 * </p>
 * 
 * @author Justin Couch
...
public class IntHashMap<T>
{
     ...
     *         key in this hashtable, as determined by the <tt>equals</tt> method; <code>false</code> otherwise.
     * @see #contains(Object)
     */
    ...
    public T get( int key )
    {
        ...
        for ( Entry e = tab[index]; e != null; e = e.next )
        {
            if ( e.hash == hash ) { return (T) e.value; }
        }
        return null;
    }
    ...
    /**
     * <p>
     * Increases the capacity of and internally reorganizes this hashtable, in order to accommodate and access its entries more
     * efficiently.
     * </p>
     * 
     * <p>
